...
from dataset import ShakespeareDataset, RandomCrop, OneHotEncoder, ToTensor
...
# Dataset
parser.add_argument('--datasetpath',    type=str,   default='shakespeare.txt', help='Path of the train txt file')
parser.add_argument('--crop_len',       type=int,   default=100,               help='Number of input letters')
parser.add_argument('--alphabet_len',   type=int,   default=38,                help='Number of letters in the alphabet')
...
if __name__ == '__main__':
    ...
    dataset = ShakespeareDataset(filepath=args.datasetpath, 
                                 transform=trans)
