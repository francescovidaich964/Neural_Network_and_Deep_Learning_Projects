...
from ulysses_dataset import UlyssesDataset, RandomCrop, OneHotEncoder, ToTensor
...
# Dataset
parser.add_argument('--datasetpath',    type=str,   default='lovecraft.txt', help='Path of the train txt file')
parser.add_argument('--crop_len',       type=int,   default=100,               help='Number of input letters')
parser.add_argument('--alphabet_len',   type=int,   default=84,                help='Number of letters in the alphabet')
...
# Save
parser.add_argument('--out_dir',     type=str,   default='lovecraft_model',    help='Where to save models and params')
...
if __name__ == '__main__':
    ...
    dataset = UlyssesDataset(filepath=args.datasetpath, crop_len=args.crop_len, transform=trans)
